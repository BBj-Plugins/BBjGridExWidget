...
* more robust delayed execution ([3ed9d1a](https://github.com/BBj-Plugins/BBjGridExWidget/commit/3ed9d1a28254c683529ae9393671ad3c09f95ed2))
* re-render when docking / undocking ([6062663](https://github.com/BBj-Plugins/BBjGridExWidget/commit/6062663daefa039d77a4c0d4992fd36d25cd0a69))
* restore ON_PAGE_LOADED callback for WebGui undocking support ([e8a27b6](https://github.com/BBj-Plugins/BBjGridExWidget/commit/e8a27b674711ebf76df4b7c67422c8a3ceb95096))
* WEBUI and GUI did sporadically not load ([79da39b](https://github.com/BBj-Plugins/BBjGridExWidget/commit/79da39b7cfda965e6095f756ae310c8691df5f94))
...
* java.lang.IndexOutOfBoundsException and java.lang.Exception: Entry not found errors in GxClientModels.bbj
 ([e4e0774](https://github.com/BBj-Plugins/BBjGridExWidget/commit/47f66bf35c99783f2c962592c7b7967c2b4c4da5)), closes [#256](https://github.com/BBj-Plugins/BBjGridExWidget/issues/263)



### Features

* implement cell editor selector
 ([c294181](https://github.com/BBj-Plugins/BBjGridExWidget/commit/c2941817c48995cfa44358e105d15b3e58ad571b)
...
# [1.13.0](https://github.com/BBj-Plugins/BBjGridExWidget/compare/1.12.2...1.13.0) (2023-10-06)
...
* :bug: Allow DWC grids to run inside BUI and DWC apps ([d815620](https://github.com/BBj-Plugins/BBjGridExWidget/commit/d815620eb035ed7156a201146f37e76789123f72)), closes [#249](https://github.com/BBj-Plugins/BBjGridExWidget/issues/249)
* :bug: Grid fails to focus and start editing a column if its empty ([cc3092a](https://github.com/BBj-Plugins/BBjGridExWidget/commit/cc3092a9681b68a530c646c5219301e030ce6106)), closes [#245](https://github.com/BBj-Plugins/BBjGridExWidget/issues/245)
* :bug: grid fails to render when the columnd id is a number ([e8d43a3](https://github.com/BBj-Plugins/BBjGridExWidget/commit/e8d43a3fc627e5c9ca453e90c59724e079f8db0f)), closes [#244](https://github.com/BBj-Plugins/BBjGridExWidget/issues/244)
* :bug: GxCellEditorSuggestion does not relocate when there is not enough space. ([fc9e390](https://github.com/BBj-Plugins/BBjGridExWidget/commit/fc9e39030985de5ed630873cc90df1e1001742ee)), closes [#248](https://github.com/BBj-Plugins/BBjGridExWidget/issues/248)



## [1.10.2](https://github.com/BBj-Plugins/BBjGridExWidget/compare/1.10.1...1.10.2) (2022-08-31)


### Bug Fixes

* [`GxColumnsManager::getColumn`](https://bbj-plugins.github.io/BBjGridExWidget/javadoc/GxColumns/GxColumnsManager.html#getColumn) and [`GxColumnsManager::hasColumn`](https://bbj-plugins.github.io/BBjGridExWidget/javadoc/GxColumns/GxColumnsManager.html#hasColumn) don't check groups ([3faa041](https://github.com/BBj-Plugins/BBjGridExWidget/commit/3faa041df837decc746d77933473928312a1fb35)), closes [#241](https://github.com/BBj-Plugins/BBjGridExWidget/issues/241)
