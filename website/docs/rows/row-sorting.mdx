...
| -------------- | ----------------------------------------------------- |
| `valueA`       | The value in the first row being compared            |
| `valueB`       | The value in the second row being compared            |
| `nodeA`        | The RowNode of the first row                          |
| `nodeB`        | The RowNode of the second row                          |
| `isDescending` | `true` when the user is sorting descending            |
