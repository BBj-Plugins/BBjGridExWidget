...
/*!*********************************!*\
  ...
  \*********************************/
/*! no static exports found */function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),n.gw_debounce=function(e,n,t){var a;return function(){var r=this,o=arguments,i=t&&!a;clearTimeout(a),a=setTimeout(function(){a=null,t||e.apply(r,o)},n),i&&e.apply(r,o)}},n.gw_sendEvent=function(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:[];if((e.interests||[]).includes(t)){var r=(0,a.gw_getDocument)().getElementById("event-bridge-".concat(e.id)),o=new CustomEvent("click");o.payload=n,r.dispatchEvent(o)}},n.gw_parseNode=r,n.gw_parseNodeFromEvent=function(e){return r(e.node,e.context)};var a=t(/*! api/utilities */"./src/api/utilities.js");function r(e,n){if(!0===e.group)return!1;var t=n.hasOwnProperty("getRowNodeId")&&e.data[n.getRowNodeId]?e.data[n.getRowNodeId]:"";return{i:t||e.id,x:t,p:e.hasOwnProperty("parent")&&e.parent.hasOwnProperty("key")?e.parent.key:"",c:e.childIndex,s:Boolean(e.selected)}}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
