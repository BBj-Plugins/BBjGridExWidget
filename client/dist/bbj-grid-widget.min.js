...
/*!**********************************!*\
  ...
  \**********************************/
/*! no static exports found */function(a,e,t){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.gw_onRowDoubleClicked=function(a){console.log(a);var e=a.api.gridOptionsWrapper.gridOptions.context;gw_sendEvent(e.id,{type:"gw.rowDoubleClick",detail:""})},e.gw_onSelectionChanged=function(a){var e=a.api.gridOptionsWrapper.gridOptions.context;gw_sendEvent(e.id,{type:"gw.rowSelect",detail:""})},e.gw_onCellClickEvent=function(a,e){var t=gw_parseNodeFromEvent(e);t&&gw_sendEvent(a,{type:"gw.".concat(e.type),detail:[[{row:t,value:gw_escape(e.value),column:e.column.colId}]]})}},"./src/events/state.js":
/*!*****************************!*\
  !*** ./src/events/state.js ***!
  \*****************************/
