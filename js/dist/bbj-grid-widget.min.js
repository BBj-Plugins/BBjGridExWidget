...
/*!****************************!*\
  !*** ./src/api/columns.js ***!
  \****************************/
/*! no static exports found */function(a,e,t){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.gw_sizeColumnsToFit=function(a){gw_getGrid(a).options.api.sizeColumnsToFit()},e.gw_setSelectedRows=function(a,e){var t=gw_getGrid(a).options;t.api.forEachNodeAfterFilterAndSort(function(a){e.indexOf(a.rowIndex)>-1&&(a.setSelected(!0),a.expanded=!0)}),t.api.onGroupExpandedOrCollapsed()},e.gw_selectAll=function(a,e){var t=gw_getGrid(a).options;1===e?t.api.selectAllFiltered():t.api.selectAll()},e.gw_deselectAll=function(a,e){var t=gw_getGrid(a).options;1===e?t.api.deselectAllFiltered():t.api.deselectAll()},e.gw_setVisibleColumn=function(a,e){gw_getGrid(a).options.api.ensureColumnVisible(e)},e.gw_setColumnWidth=function(a,e,t){gw_getGrid(a).options.columnApi.setColumnWidth(e,Number(t))},e.gw_pinColumn=function(a,e,t){gw_getGrid(a).options.columnApi.setColumnPinned(e,t)},e.gw_moveColumn=function(a,e,t){gw_getGrid(a).options.columnApi.moveColumn(e,t)},e.gw_groupColumns=function(a,e){var t=function(t){if(!a||!a.hasOwnProperty(t))return"continue";var i=JSON.parse(a[t]),g=i.children.split(","),o=[];g.forEach(function(a){for(var t=0;t<e.length;t++){var i=e[t];if(i&&i.hasOwnProperty("field")&&i.field===a){o.push(i),e.splice(t,1);break}}}),i.children=o,e.unshift(i)};for(var i in a)t(i)}},"./src/api/jss.js":
/*!************************!*\
  !*** ./src/api/jss.js ***!
  \************************/
...
/*!**********************************!*\
  ...
  \**********************************/
/*! no static exports found */function(a,e,t){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.gw_onRowSelected=function(a,e){i.push(e)},e.gw_onRowDoubleClicked=function(a,e){var t=gw_parseNodeFromEvent(e);t&&gw_sendEvent(a,{type:"gw.rowDoubleClick",detail:[[t]]})},e.gw_onSelectionChanged=function(a,t){var g=[];i.forEach(function(a){var e=gw_parseNodeFromEvent(a);e&&g.push(e)}),g.length&&(e.gw_selectedRowsStack=i=[],gw_sendEvent(a,{type:"gw.rowSelecte",detail:[g]}))},e.gw_onCellClickEvent=function(a,e){var t=gw_parseNodeFromEvent(e);t&&gw_sendEvent(a,{type:"gw.".concat(e.type),detail:[[{row:t,value:gw_escape(e.value),column:e.column.colId}]]})},e.gw_selectedRowsStack=void 0;var i=[];e.gw_selectedRowsStack=i},"./src/events/state.js":
/*!*****************************!*\
  !*** ./src/events/state.js ***!
  \*****************************/
...
/*!*********************************!*\
  ...
  \*********************************/
/*! no static exports found */function(a,e,t){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.gw_sendEvent=function(a,e){var t=gw_getDocument().getElementById("event-bridge-".concat(a)),i=new CustomEvent("click");i.payload=e,t.dispatchEvent(i)},e.gw_parseNodeFromEvent=function(a){return!0!==a.node.group&&{id:!a.context.getRowNodeId&&a.node.data.__ROW_INDEX?a.node.data.__ROW_INDEX:a.node.id,index:a.node.data.__ROW_INDEX?a.node.data.__ROW_INDEX:"",parentKey:a.node.hasOwnProperty("parent")&&a.node.parent.hasOwnProperty("key")?a.node.parent.key:"",childIndex:a.node.childIndex,selected:Boolean(a.node.selected)}}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
