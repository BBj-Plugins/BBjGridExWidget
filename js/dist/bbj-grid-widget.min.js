...
/*!**************************!*\
  !*** ./src/api/menus.js ***!
  \**************************/
/*! no static exports found */function(a,e,t){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.gw_getContextMenu=function(a,e){return function a(t){var i=JSON.parse(t);return i.forEach(function(t){"string"!=typeof t&&(t.action=function(a,e){return function(){var t=gw_parseNodeFromEvent(a),i=a.column.colId,g=a.value;gw_sendEvent({type:"contextmenu",detail:[[{row:t,column:i,value:g,id:e}]]})}}(e,t.id),t.cssClasses&&(t.cssClasses=t.cssClasses.split(" ")),t.subMenu&&(t.subMenu=a(t.subMenu)))}),i}((0,i.gw_getGrid)(a).options.context.contextMenu)};var i=t(/*! ../utilities */"./src/utilities.js")},"./src/api/rows.js":
/*!*************************!*\
  !*** ./src/api/rows.js ***!
  \*************************/
